...
export default function Header() {
  ...
  const links = ["Sobre", "Habilidades", "Projetos", "Experiência"];
  return (
<header
...
>
  <div className="max-w-7xl w-full mx-auto py-4 px-6 flex items-center justify-between">
    ...
    {/* Menu Desktop */}
    <nav className="hidden md:flex gap-10 text-md font-semibold text-gray-300">
      {links.map((link) => (
        <a
          key={link}
  ...
  {/* Menu Mobile */}
  {open && (
    <div className="md:hidden w-full bg-black/95 backdrop-blur border-t border-white/5">
